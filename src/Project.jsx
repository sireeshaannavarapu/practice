...
function Project(){
    ...
    return(
        ...
        tour.map((place,i)=>{
            return <div>
            <center>
            <div class="card" style={{width:"40%",height:"60%",marginBottom:"30px"}}>
             <img src={place.image} style={{width:"400px",padding:"5px"}} alt="" />
             <div class="card-body" style={{width:"400px",padding:"5px"}}>
